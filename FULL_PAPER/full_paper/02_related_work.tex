...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1.0\textwidth]{images/bevfusion_architecture.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1.0\textwidth]{images/bevdet_architecture.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1.0\textwidth]{images/autoware.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1.0\textwidth]{images/vad_architecture.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1.0\textwidth]{images/ppgeo.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1.0\textwidth]{images/transfusion.png}
...
\section*{Comparison of Integrated ADAS Frameworks}
\begin{table}[ht]
\centering
...
\begin{tabular}{p{3.2cm} p{3cm} p{3.5cm} p{3cm}}
\toprule
...
\begin{table}[ht]
\centering
\caption{Comparison of Multi-Sensor Early Fusion Methods}
\label{tab:fusion_comparison}
\begin{tabular}{p{3cm} p{4cm} p{4cm} p{3cm}}
\toprule
\textbf{Method} & \textbf{Fusion Strategy} & \textbf{Notable Features / Performance} & \textbf{Modality Support} \\
\midrule
BEVFusion & BEV-level fusion of camera + LiDAR; camera stream independent of LiDAR & Up to 40× reduced latency; +1.3 % mAP and NDS, +13.6 % mIoU; robust to LiDAR failures :contentReference[oaicite:0]{index=0} & Camera + LiDAR \\
\midrule
BEVDet / BEVDet4D & Camera-only BEV detection; temporal fusion in 4D improves velocity & NDS from ~0.403 to ~0.476; velocity error reduced by 62.9% :contentReference[oaicite:1]{index=1} & Camera only \\
\midrule
CenterFusion & Mid-level fusion: associates radar detections via frustum to image centers & Improves NDS by over 12%; better velocity estimation without temporal data :contentReference[oaicite:2]{index=2} & Camera + Radar \\
\midrule
HVDetFusion & BEV fusion of camera + radar; camera stream independent; radar enhances BEV features & Achieves 67.4 % NDS on nuScenes (camera + radar) :contentReference[oaicite:3]{index=3} & Camera + Radar \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{lccc}
\hline
\textbf{Architecture Style} & \textbf{VRAM Usage} & \textbf{Relative Saving} & \textbf{Notes} \\
\hline
Monolithic E2E (e.g., UniAD) & 12--16~GB & --- & Joint perception--planning--control, large BEV features persist in memory \\
Modular + dense BEV passing  & 8--10~GB  & 30--40\% & Modules separated, but high-res BEV features exchanged \\
Modular + occupancy/vector map & 5--8~GB & 50--60\% & Compact intermediate representations (occupancy grids, vector maps) \\
Modular + CPU planning/control & 4--6~GB & 60--70\% & Perception on GPU, planning/control on CPU or embedded accelerators \\
\hline
\end{tabular}
\end{table}
